...
(function(){
    ...
    !function(t){
        ...
        function model(end){
            if(end){
                ...
                setTimeout(() =>{
                    this.modelBox.classList.replace("m-adjustUpward", "m-default-position");
                }, 2417);
            ...
            (function(c){
            ...
            })(
                {
                    ...
                    animationA(){
                        ...
                        setTimeout(() =>{
                            animationElement.cards[0].classList.replace("display-n", "display-b");
                        }, 0);
                        setTimeout(() =>{
                            animationElement.cards[0].classList.replace("toLeft", "toRight");
                            animationElement.cards[1].classList.replace("display-n", "display-b");
                        }, 50);
                    ...
                    animationB(){
                        ...
                        function animationPhaseOne(){
                            setTimeout(() =>{
                                animationElement.section.classList.replace("display-n", "display-b");
                            }, 100);
                            setTimeout(() =>{
                        ...
                        function animationPhaseTwo(){
                            setTimeout(() =>{
                                animationElement.sectionHeader.classList.replace("toLeft", "toRight");
                            }, 900);
                            setTimeout(() =>{
                                animationElement.sectionFooter.classList.replace("toLeft", "toRight");
                            }, 950);
                            setTimeout(() =>{
                                animationElement.sectionHeader.classList.replace("fadeOut", "fadeIn");
                            }, 1000);
                            setTimeout(() =>{
                                animationElement.sectionFooter.classList.replace("fadeOut", "fadeIn");
                            }, 1050);
                        ...
                        function animationPhaseThree(){
                            setTimeout(() =>{
                                animationElement.imgBoxes[0].classList.replace("shrink", "popOut");
                            }, 1350);
                            setTimeout(() =>{
                                animationElement.imgBoxes[1].classList.replace("shrink", "popOut");
                            }, 1550);
                            setTimeout(() =>{
                                animationElement.imgBoxes[2].classList.replace("shrink", "popOut");
                            }, 1750);
                            setTimeout(() =>{
    ...
    ( function(){
            ...
            function onfocus(e){
                    ...
                    const input_title = [...e_parent.children].filter(e => e.classList.contains("input-title"));
        ...
        !function(b, e, r, z){
            ...
            const budgetBlock = () =>{
                ...
                if(b.call(z, input)){
                    ...
                    if(e_amt.textContent){
                        ...
                        balance.textContent = `$${r(z, getTotalBalanceFromBudgetVal, null, budgetVal).noDollarPad - Number(expensesVal)}`;
            ...
            const expensesBuilder = () => {
                ...
                if(e().addExpenses.call(z, input_eName, input_eAmount)){
                    ...
                    div_eAmt.textContent = e().addExpenses.call(z, input_eName, input_eAmount).str;
                    div_eName.appendChild(eName_SPAN);
                    Btn.textContent = 'Delete';

                    replaceWith(blankBox, span);

                    const newValToString = expenses(e().addExpenses.call(z, input_eName, input_eAmount).int);
                    ...
                    if(span_Budget.textContent){
                        ...
                        balance.textContent = `$${r(z, null, subExpenseFromBudgetVal, budgetVal).noDollarPad - newValToString}`;
                        replaceWith(balance_BlankBox, balance);
            ...
            const delItem = (event) =>{
                ...
                if(event.target.className === 'del-btn'){
                    ...
                    const span = document.querySelector('.e-val');
                    const newValToString = expenses(-e().delExepenses.call(z, event.target));
                    ...
                    balance.textContent = `$${Number(balance_Txt) + Number(deletedExpenses)}`;
                    span.textContent = `$${newValToString}`;
            ...
            return {
                ...
                delExepenses(n){
                    ...
                    const e_amtInStr = n.parentNode.previousElementSibling.children[1].textContent;
                ...
                const validate = (args, n) => {
                    ...
                    const e = (i, v, p) => {
                        if(Number(i.value) || Number(i.value) <= 0){
                            ...
                            return {
                                error(){
                                    throw new TypeError("Input value should contain only numbers");
                                },
                                state: false,
                            }
